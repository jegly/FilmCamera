...
data class FilmStock(
    ...
    /** Absolute path to a user-imported .cube/HaldCLUT file. Null for built-in films. */
    val lutFilePath: String? = null,
    val lutType: LutType = if (lutResId == null && lutFilePath == null) LutType.PRESET else LutType.CUBE,
