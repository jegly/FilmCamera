package com.jegly.filmcamera.ui.theme
...
private val FilmCameraColorScheme = darkColorScheme(
...
@Composable
fun FilmCameraTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = FilmCameraColorScheme,
        content = content,
    )
}
